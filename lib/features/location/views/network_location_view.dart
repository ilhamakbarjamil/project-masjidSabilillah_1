...
class NetworkLocationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(NetworkLocationController());
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(
            child: GetBuilder<NetworkLocationController>(
              builder: (controller) {
                return FlutterMap(
                  options: MapOptions(
  ...
  children: [
    TileLayer(
      ...
      userAgentPackageName: 'com.example.masjid_sabilillah',
          ...
          GetBuilder<NetworkLocationController>(
            builder: (controller) {
              return Card(
                    ...
                    children: [
                      ...
                      _buildInfoRow(
                        ...
                        DateFormat('HH:mm:ss').format(
                          controller.currentPosition.value.timestamp,
                        ),
                      ),
                    ],
                  ),
